...
public class AdicionarContatoPessoaTest {
    ...
    void deveAdicionarContatoAUmaPessoa() {
        ...
        assertThat(output.idPessoa()).isEqualTo(idPessoaDefault);
        assertThat(output.nome()).isEqualTo(NOVO_CONTATO_DEFAULT);
        assertThat(output.telefone()).isEqualTo(NOVO_TELEFONE_DEFAULT);
        assertThat(output.email()).isEqualTo(NOVO_EMAIL_DEFAULT);

        BuscarContatoPessoa.Output outputBuscar = buscarContatoPessoa.execute(idPessoaDefault, output.id());
        assertThat(outputBuscar.id()).isNotNull();
        assertThat(outputBuscar.nome()).isEqualTo(NOVO_CONTATO_DEFAULT);
        assertThat(outputBuscar.telefone()).isEqualTo(NOVO_TELEFONE_DEFAULT);
        assertThat(outputBuscar.email()).isEqualTo(NOVO_EMAIL_DEFAULT);
    }
